...
if ($task_open&&$shop_open) {
	$case_list = kekezu::get_table_data ( "case_id,obj_id,obj_type,case_img,case_title,case_price", "witkey_case", "", "", "", "6", "", 3600 );
}elseif($task_open&&!$shop_open){
	$case_list = kekezu::get_table_data ( "case_id,obj_id,obj_type,case_img,case_title,case_price", "witkey_case", " obj_type='task' ", "", "", "7", "", 3600 );
}elseif(!$task_open&&$shop_open){
	$case_list = kekezu::get_table_data ( "case_id,obj_id,obj_type,case_img,case_title,case_price", "witkey_case", " obj_type='service' ", "", "", "7", "", 3600 );
}
