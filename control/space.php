...
if($space_config==2){
	kekezu::show_msg ( $_lang['system prompt'], "index.php?do=index", '1', '¿Õ¼äÄ£¿éÎ´¿ªÆô', 'alert_error' ) ;
}
...
if ( $p_shop_info[0]['shop_status']!=1) { 
	kekezu::show_msg ( $_lang['system prompt'], "index.php?do=index", '1', 'ÄúµÄµêÆÌÎ´Í¨¹ýÉóºË£¡', 'alert_error' ) ;
}
