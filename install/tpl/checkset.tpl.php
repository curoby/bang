...
<body>
	<div class="wrapper">
    	<div class="container">
            ...
            <div class="content">
                ...
                <div class="cont">
                	<div class="conts">
                    	<div class="conts_top"><p class="huan_j"><?php echo L('detec_env'); ?>£º</p></div>
                    <div class="conts_m">
  ...
  <tr>
	...
	<div class="conts_t"><p class="huan_j"><?php echo L('directory_test'); ?>£º</p></div>
                    <div class="conts_m">
                    	<table width="790px" border="0" cellspacing="10px" cellpadding="0">
  <tr class="tls">
  ...
  <?php } ?>
                    ...
                    <div class="conts_ts"><p class="huan_j"><?php echo L('func_test'); ?>£º</p></div>
                    <div class="conts_m">
                    	<table width="790px" border="0" cellspacing="10px" cellpadding="0">
  <tr class="tls">
