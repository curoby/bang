...
class keke_shop_class {
	...
	public static function create_service_order($service_info) {
		...
		if ($order_id) {
			kekezu::update_weibo_data($service_info ['service_id'],'service',$detail_type,$service_info ['title'],$service_info['uid'],$service_info['username'], $service_info['leave_num'],$service_info['focus_num'],intval($service_info['work_num'])+1,'buy',$service_cash,$uid,$username);
